...
from rapid_ocr_engine import HAS_RAPIDOCR, image_to_data, image_to_string

HAS_OCR = HAS_RAPIDOCR
...
class OCRProcessor:
    ...
    Extracts text from images and PDFs using RapidOCR (ONNX).
    """
    ...
    def extract_by_page(self) -> Dict[int, str]:
        ...
        for idx, img in enumerate(self._images):
            results[idx + 1] = image_to_string(img)
        return results
